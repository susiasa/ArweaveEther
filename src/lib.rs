...
#[derive(Debug)]
pub struct ArweaveEtherProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ArweaveEtherProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ArweaveEther processing");
    
    let mut processor = ArweaveEtherProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ArweaveEtherProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ArweaveEtherProcessor::new(false);
